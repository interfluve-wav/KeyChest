...
pub use proxy::{
    ...
    proxy_detect_tools, proxy_diagnostics, proxy_discover, proxy_force_reset, proxy_list_agents,
    proxy_list_bindings, proxy_list_credentials, proxy_list_invites, proxy_list_policy_templates,
    proxy_list_proposals, proxy_list_rules, proxy_redeem_invite, proxy_revoke_agent,
    proxy_rotate_agent_token, proxy_rule_test, proxy_start, proxy_status, proxy_stop,
    proxy_write_tool_launcher, AuditEntry, DiscoverResponse, DiscoverService, ProxyAgent,
    ProxyBinding, ProxyCredential, ProxyDiagnostics, ProxyInvite, ProxyPolicyTemplate,
    ProxyProposal, ProxyRedeemInviteResponse, ProxyRule, ProxyRuleTestRequest,
    ProxyRuleTestResponse, ProxyStatus, ProxyToolDetection, ProxyToolLauncherWriteResult,
};
